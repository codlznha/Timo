    ...
    <body>
        ...
        <%@ include file="/views/common/sidebar.jsp" %>
            ...
            <nav class="bottom-nav">
                <a href="${pageContext.request.contextPath}/main/main" class="nav-item"><i class="fa-solid fa-house"></i><span>홈</span></a>
                <a href="${pageContext.request.contextPath}/club/main" class="nav-item"><i class="fa-solid fa-shield-halved"></i><span>동아리</span></a>
                <a href="${pageContext.request.contextPath}/meet/map" class="nav-item"><i class="fa-solid fa-map-location-dot"></i><span>지도</span></a>
                <a href="${pageContext.request.contextPath}/main/board" class="nav-item active"><i
                        class="fa-solid fa-clipboard-list"></i><span>게시판</span></a>
                <a href="${pageContext.request.contextPath}/my/mypage" class="nav-item"><i class="fa-solid fa-user"></i><span>MY</span></a>
            </nav>
