...
<body>
            ...
            <div class="section-card">
                ...
                <form class="apply-form" id="addClubForm" onsubmit="return submitClubForm(event)">
                    ...
                    <div class="form-actions">
                        <button type="button" class="btn btn-cancel" onclick="location.href='${pageContext.request.contextPath}/club/main'">취소</button>
    ...
    <script>
        ...
        function submitClubForm(e) {
            ...
            location.href = '${pageContext.request.contextPath}/club/main';
            return false;
        }
    </script>
